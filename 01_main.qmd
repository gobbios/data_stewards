...
# some more practical issues and other considerations
...
- only comit when something is finished, i.e. only after a completed work package
  
- if in doubt, commit more frequently rather than too rarely

- don't commit in the middle of something or because you wanna go home

- take a moment to think about the commit before you do commit

- commit message:
  
  - short (title plus optional description)
  
  - Why was the change necessary? How has it changed?

## should my data live in my repository

- it depends

- if possible: yes!

- for data that is used across multiple projects, a shared data source (which in itself could a repository) is preferable

- for data with privacy issues or other legal concerns, you probably need to find a custom solution
